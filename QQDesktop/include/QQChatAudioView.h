...
class QQChatAudioView : public QWidget
{
	Q_OBJECT
	Q_MPROPERTY_CREATE(QString, MFileName, m_fileName)
	Q_MPROPERTY_CREATE(qreal, MMax, m_max)
	Q_MPROPERTY_CREATE(qreal, MMin, m_min)
public:
	explicit QQChatAudioView(QWidget *parent = nullptr);
	virtual ~QQChatAudioView();
...
#endif
signals:
	void sign_overTheLimit(int time);
	void sign_exit();
private slots:
